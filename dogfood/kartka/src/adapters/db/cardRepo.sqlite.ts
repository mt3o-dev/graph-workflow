...
import { cards, sets } from "./schema.sqlite";
import type { CardRepoPort } from "../../core/ports/cardRepoPort";
import type { Card, CardPayload, CardType, PageQuery, Paginated } from "../../core/domain/types";
...
export function createCardRepoSqlite(db: SqliteDb): CardRepoPort {
  return {
    async create(input) {
      const row = {
        id: newId(),
