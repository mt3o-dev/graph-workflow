...
import type { SqliteDb } from "../db/index";
...
export function createAuthAdapterSqlite(db: SqliteDb, sessionSecret: string): AuthPort {
  return {
...
export async function pruneExpiredSessionsSqlite(db: SqliteDb): Promise<void> {
